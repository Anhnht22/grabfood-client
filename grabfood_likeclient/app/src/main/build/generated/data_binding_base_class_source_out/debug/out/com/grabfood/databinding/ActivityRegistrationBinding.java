...
public final class ActivityRegistrationBinding implements ViewBinding {
  ...
  private ActivityRegistrationBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull EditText editText, @NonNull EditText editText3, @NonNull EditText editText5,
      @NonNull ImageView imageView4, @NonNull ConstraintLayout main, @NonNull TextView textView2,
  ...
  public static ActivityRegistrationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegistrationBinding((ConstraintLayout) rootView, button, editText,
          editText3, editText5, imageView4, main, textView2, textView4, textView6);
    }
